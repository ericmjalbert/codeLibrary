...
/* Global Variables */
realtype c = 0.0044360187373969;                                 /* wavespeed */
...
int main()
{
    ...
    cvode_mem = NULL;
            ...
            y = N_VNew_Serial(NEQ);
            NV_Ith_S(y, 0) = 0.9499999853810676;
            NV_Ith_S(y, 1) = -0.0001602418923988;
            
            

/*            NV_Ith_S(y,0) = 0.0000000000010000;*/
/*            NV_Ith_S(y,1) = -4436018737077.8115234375000000;*/
...
/*                    printf("c = %.16f | %.16f %.16f | tout = %.8f\n", c, NV_Ith_S(y,0), NV_Ith_S(y,1), tout);*/
                ...
                if(NV_Ith_S(y,0) <= 0.0000000000010000)
                  break;
                
                
/*                if(NV_Ith_S(y,0) >= 0.95)*/
/*                  break;*/
